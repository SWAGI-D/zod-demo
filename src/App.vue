<template>
  <VForm @submit.prevent="onSubmit">
    <div>
      <VTextField label="Name" type="text" id="name" name="name" v-model="formData.name" @input="clearError('name')" :error-messages="validationErrors.name"/>
    </div>
    <div>
      <VNumberInput label="Age" type="number" id="age" name="age" v-model="formData.age" @input="clearError('age')" :error-messages="validationErrors.age" required/>
    </div>
    <div>
      <VTextField label="Email" type="email" id="email" name="email" v-model="formData.email" @input="clearError('email')" :error-messages="validationErrors.email"/>
    </div>
    <div>
      <VTextField label="Password" type="password" id="password" name="password" v-model="formData.password" @input="clearError('password')" :error-messages="validationErrors.password"/>
    </div>
    <div>
      <VTextField label="Confirm Password" type="password" id="confirmPassword" name="confirmPassword" v-model="formData.confirmPassword" @input="clearError('confirmPassword')" :error-messages="validationErrors.confirmPassword"/>
    </div>
...
function clearError(field: keyof Employee) {
